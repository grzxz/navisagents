...
- Your agent response using Filecoin data as context alongside current data via Google Search
...
Adding Filecoin Context to Agents - Filecoin Content Identifiers allow Navis Agents to reference decentralized data:
